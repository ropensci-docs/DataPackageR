...
- We recommend that you create a Git branch for each pull request (PR)
  and keep issues addressed to one issue per branch.  
- Look at the git workflow checks before and after making changes. The
...
[Contributor Code of
Conduct](https://docs.ropensci.org/DataPackageR/CODE_OF_CONDUCT.md). By
...
- Headings are in sentence case and contain a period at the end of the
...
- Vignette file names are snake cased with capital first letters:
  Like_This.Rmd
